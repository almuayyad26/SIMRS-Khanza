...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private PreparedStatement ps, pscariwilayah, pssetalamat, pskelengkapan, pskel, pskec, pskab, psprov;
    ...
    public DlgPasien(java.awt.Frame parent, boolean modal) {
        ...
        nmperusahaan.setName("nmperusahaan");
        nmperusahaan.setText("-");
        nmbahasa = new widget.TextBox();
        nmbahasa.setName("nmbahasa");
        nmbahasa.setText("Sunda");
        nmsukubangsa = new widget.TextBox();
        nmsukubangsa.setName("nmsukubangsa");
        nmsukubangsa.setText("Sunda");
        ...
        PekerjaanPj.setName("PekerjaanPj");
        PekerjaanPj.setText("-");
...
//            LabelJabatanTNI.setVisible(false);
    ...
    private void initComponents() {
        ...
        ChkAlamatPJ = new javax.swing.JCheckBox();
        ...
        TUmurHr = new javax.swing.JTextField();
        TUmurTh = new javax.swing.JTextField();
        TUmurBl = new javax.swing.JTextField();
        jSeparator6 = new javax.swing.JSeparator();
        jLabel32 = new javax.swing.JLabel();
        Alamat = new javax.swing.JTextField();
        jSeparator7 = new javax.swing.JSeparator();
        Saudara = new javax.swing.JTextField();
        jLabel36 = new javax.swing.JLabel();
        TNoPeserta = new javax.swing.JTextField();
        ...
        lblNamaPJ = new javax.swing.JLabel();
        jLabel44 = new javax.swing.JLabel();
        TTlp = new javax.swing.JTextField();
        jSeparator10 = new javax.swing.JSeparator();
        lblAlamatPJ = new javax.swing.JLabel();
        AlamatPj = new javax.swing.JTextField();
        CMbGd = new widget.ComboBox();
        CmbKab = new widget.ComboBox();
        CmbCacat = new widget.ComboBox();
        CmbProv = new widget.ComboBox();
        CmbKel = new widget.ComboBox();
        CmbKec = new widget.ComboBox();
        CmbSebutan = new widget.ComboBox();
        CmbJk = new widget.ComboBox();
        CmbKeluarga = new widget.ComboBox();
        CmbStts = new widget.ComboBox();
        CmbKelPJ = new widget.ComboBox();
        CmbKecPJ = new widget.ComboBox();
        CmbKabPJ = new widget.ComboBox();
        CmbProvPJ = new widget.ComboBox();
        ...
        TabRawat.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2024" }));
        ...
        nmcacat.setText("PROPINSI");
        nmcacat.setHighlighter(null);
        ...
        nmcacat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                nmcacatKeyPressed(evt);
            }
        });
        ...
        internalFrame2.setPreferredSize(new java.awt.Dimension(1092, 270));
        ...
        jPanel1.setMinimumSize(new java.awt.Dimension(300, 470));
        jPanel1.setName("jPanel1"); // NOI18N
        jPanel1.setPreferredSize(new java.awt.Dimension(300, 470));
        ...
        TNm.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        TNm.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        TNm.setName("TNm"); // NOI18N
        jPanel5.add(TNm);
        TNm.setBounds(130, 49, 340, 26);

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel5.setText("No. RM");
        jLabel5.setName("jLabel5"); // NOI18N
        jPanel5.add(jLabel5);
        jLabel5.setBounds(420, 10, 50, 20);

        TNo.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        TNo.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        TNo.setName("TNo"); // NOI18N
        jPanel5.add(TNo);
        TNo.setBounds(480, 7, 60, 26);

        ChkAlamatPJ.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ChkAlamatPJ.setSelected(true);
        ChkAlamatPJ.setText("SAMA");
        ChkAlamatPJ.setBorder(null);
        ChkAlamatPJ.setName("ChkAlamatPJ"); // NOI18N
        ChkAlamatPJ.setOpaque(true);
        ChkAlamatPJ.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                ChkAlamatPJItemStateChanged(evt);
            }
        });
        jPanel5.add(ChkAlamatPJ);
        ChkAlamatPJ.setBounds(130, 385, 60, 26);

        BtnCariBPJS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/accept.png"))); // NOI18N
        BtnCariBPJS.setMnemonic('5');
        BtnCariBPJS.setText("CEK BPJS");
        BtnCariBPJS.setToolTipText("Alt+5");
        ...
        jPanel5.add(BtnCariBPJS);
        BtnCariBPJS.setBounds(270, 10, 90, 23);

        jSeparator2.setForeground(new java.awt.Color(204, 204, 204));
        jSeparator2.setName("jSeparator2"); // NOI18N
        jPanel5.add(jSeparator2);
        jSeparator2.setBounds(0, 378, 620, 10);

        jLabel12.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel12.setText("No. KTP / NIK");
        jLabel12.setName("jLabel12"); // NOI18N
        jPanel5.add(jLabel12);
        jLabel12.setBounds(10, 10, 110, 20);

        TTmp.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        TTmp.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        TTmp.setName("TTmp"); // NOI18N
        jPanel5.add(TTmp);
        TTmp.setBounds(130, 129, 110, 26);

        jSeparator3.setForeground(new java.awt.Color(204, 204, 204));
        jSeparator3.setName("jSeparator3"); // NOI18N
        jPanel5.add(jSeparator3);
        jSeparator3.setBounds(0, 40, 620, 10);

        jLabel14.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel14.setText("TTL");
        jLabel14.setName("jLabel14"); // NOI18N
        jPanel5.add(jLabel14);
        jLabel14.setBounds(10, 130, 110, 20);

        jSeparator4.setForeground(new java.awt.Color(204, 204, 204));
        jSeparator4.setName("jSeparator4"); // NOI18N
        jPanel5.add(jSeparator4);
        jSeparator4.setBounds(0, 80, 620, 10);

        jLabel18.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel18.setText("Umur");
        jLabel18.setName("jLabel18"); // NOI18N
        jPanel5.add(jLabel18);
        jLabel18.setBounds(410, 130, 50, 20);

        DTPLahir.setBorder(null);
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-06-2024" }));
        DTPLahir.setDisplayFormat("dd-MM-yyyy");
        DTPLahir.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        ...
        jPanel5.add(DTPLahir);
        DTPLahir.setBounds(250, 129, 130, 26);

        jLabel23.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel23.setText("Jenis Kelamin");
        jLabel23.setName("jLabel23"); // NOI18N
        jPanel5.add(jLabel23);
        jLabel23.setBounds(10, 90, 110, 20);

        jLabel26.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel26.setText("Gol. Darah");
        jLabel26.setName("jLabel26"); // NOI18N
        jPanel5.add(jLabel26);
        jLabel26.setBounds(420, 90, 80, 20);

        TUmurHr.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        TUmurHr.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        TUmurHr.setText("23");
        TUmurHr.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        TUmurHr.setName("TUmurHr"); // NOI18N
        jPanel5.add(TUmurHr);
        TUmurHr.setBounds(540, 129, 30, 26);

        TUmurTh.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        TUmurTh.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        TUmurTh.setText("123");
        TUmurTh.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        TUmurTh.setName("TUmurTh"); // NOI18N
        jPanel5.add(TUmurTh);
        TUmurTh.setBounds(450, 129, 40, 26);

        TUmurBl.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        TUmurBl.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        TUmurBl.setText("23");
        TUmurBl.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        TUmurBl.setName("TUmurBl"); // NOI18N
        jPanel5.add(TUmurBl);
        TUmurBl.setBounds(500, 129, 30, 26);

        jSeparator6.setForeground(new java.awt.Color(204, 204, 204));
        jSeparator6.setName("jSeparator6"); // NOI18N
        jPanel5.add(jSeparator6);
        jSeparator6.setBounds(0, 120, 620, 10);

        jLabel32.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel32.setText("Alamat Pasien");
        jLabel32.setName("jLabel32"); // NOI18N
        jPanel5.add(jLabel32);
        jLabel32.setBounds(10, 170, 110, 20);
        ...
        jPanel5.add(Alamat);
        Alamat.setBounds(130, 168, 440, 26);

        jSeparator7.setForeground(new java.awt.Color(204, 204, 204));
        jSeparator7.setName("jSeparator7"); // NOI18N
        jPanel5.add(jSeparator7);
        jSeparator7.setBounds(0, 160, 620, 10);

        Saudara.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        Saudara.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        Saudara.setName("Saudara"); // NOI18N
        jPanel5.add(Saudara);
        Saudara.setBounds(360, 347, 210, 26);

        jLabel36.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel36.setText("No. Asuransi");
        jLabel36.setName("jLabel36"); // NOI18N
        jPanel5.add(jLabel36);
        jLabel36.setBounds(310, 267, 90, 30);

        TNoPeserta.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        TNoPeserta.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        TNoPeserta.setName("TNoPeserta"); // NOI18N
        jPanel5.add(TNoPeserta);
        TNoPeserta.setBounds(400, 269, 170, 26);

        jLabel37.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel37.setText("Status");
        jLabel37.setName("jLabel37"); // NOI18N
        jPanel5.add(jLabel37);
        jLabel37.setBounds(10, 308, 110, 26);

        TKtp.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        TKtp.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        ...
        jPanel5.add(TKtp);
        TKtp.setBounds(130, 7, 130, 26);

        jSeparator8.setForeground(new java.awt.Color(204, 204, 204));
        jSeparator8.setName("jSeparator8"); // NOI18N
        jPanel5.add(jSeparator8);
        jSeparator8.setBounds(0, 261, 620, 10);

        jLabel39.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel39.setText("No. Handphone");
        jLabel39.setName("jLabel39"); // NOI18N
        jPanel5.add(jLabel39);
        jLabel39.setBounds(10, 267, 110, 30);

        jLabel40.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel40.setText("Cacat Fisik");
        jLabel40.setName("jLabel40"); // NOI18N
        jPanel5.add(jLabel40);
        jLabel40.setBounds(320, 308, 90, 26);

        jSeparator9.setForeground(new java.awt.Color(204, 204, 204));
        jSeparator9.setName("jSeparator9"); // NOI18N
        jPanel5.add(jSeparator9);
        jSeparator9.setBounds(0, 300, 620, 10);

        lblNamaPJ.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        lblNamaPJ.setText("Nama");
        lblNamaPJ.setName("lblNamaPJ"); // NOI18N
        jPanel5.add(lblNamaPJ);
        lblNamaPJ.setBounds(310, 347, 50, 26);

        jLabel44.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        jLabel44.setText("Png. Jawab");
        jLabel44.setName("jLabel44"); // NOI18N
        jPanel5.add(jLabel44);
        jLabel44.setBounds(10, 347, 110, 26);

        TTlp.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        TTlp.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        TTlp.setName("TTlp"); // NOI18N
        jPanel5.add(TTlp);
        TTlp.setBounds(130, 269, 120, 26);

        jSeparator10.setForeground(new java.awt.Color(204, 204, 204));
        jSeparator10.setName("jSeparator10"); // NOI18N
        jPanel5.add(jSeparator10);
        jSeparator10.setBounds(0, 339, 620, 10);

        lblAlamatPJ.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        lblAlamatPJ.setText("Alamat PJ");
        lblAlamatPJ.setName("lblAlamatPJ"); // NOI18N
        jPanel5.add(lblAlamatPJ);
        lblAlamatPJ.setBounds(10, 385, 110, 26);

        AlamatPj.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        AlamatPj.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        AlamatPj.setName("AlamatPj"); // NOI18N
        jPanel5.add(AlamatPj);
        AlamatPj.setBounds(190, 385, 380, 26);

        CMbGd.setBorder(null);
        CMbGd.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "O", "A", "AB", "B" }));
        CMbGd.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        ...
        jPanel5.add(CMbGd);
        CMbGd.setBounds(490, 89, 80, 26);

        CmbKab.setBorder(null);
        CmbKab.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "KABUPATEN / KOTA" }));
        CmbKab.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbKab.setName("CmbKab"); // NOI18N
        CmbKab.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbKabItemStateChanged(evt);
            }
        });
        CmbKab.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbKabKeyPressed(evt);
            }
        });
        jPanel5.add(CmbKab);
        CmbKab.setBounds(370, 200, 200, 26);

        CmbCacat.setBorder(null);
        CmbCacat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TIDAK ADA" }));
        CmbCacat.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbCacat.setName("CmbCacat"); // NOI18N
        CmbCacat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbCacatKeyPressed(evt);
            }
        });
        jPanel5.add(CmbCacat);
        CmbCacat.setBounds(400, 308, 170, 26);

        CmbProv.setBorder(null);
        CmbProv.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "PROVINSI" }));
        CmbProv.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbProv.setName("CmbProv"); // NOI18N
        ...
        CmbProv.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbProvKeyPressed(evt);
            }
        });
        jPanel5.add(CmbProv);
        CmbProv.setBounds(130, 200, 200, 26);

        CmbKel.setBorder(null);
        CmbKel.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "KELURAHAN / DESA" }));
        CmbKel.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbKel.setName("CmbKel"); // NOI18N
        CmbKel.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbKelItemStateChanged(evt);
            }
        });
        CmbKel.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbKelKeyPressed(evt);
            }
        });
        jPanel5.add(CmbKel);
        CmbKel.setBounds(370, 230, 200, 26);

        CmbKec.setBorder(null);
        CmbKec.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "KECAMATAN" }));
        CmbKec.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbKec.setName("CmbKec"); // NOI18N
        CmbKec.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbKecItemStateChanged(evt);
            }
        });
        CmbKec.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbKecKeyPressed(evt);
            }
        });
        jPanel5.add(CmbKec);
        CmbKec.setBounds(130, 230, 200, 26);

        CmbSebutan.setBorder(null);
        CmbSebutan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TN", "NY", "NN", "SDR", "AN", "BY", "BY NY" }));
        CmbSebutan.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbSebutan.setName("CmbSebutan"); // NOI18N
        CmbSebutan.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbSebutanItemStateChanged(evt);
            }
        });
        CmbSebutan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbSebutanKeyPressed(evt);
            }
        });
        jPanel5.add(CmbSebutan);
        CmbSebutan.setBounds(490, 49, 80, 26);

        CmbJk.setBorder(null);
        CmbJk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "LAKI-LAKI", "PEREMPUAN" }));
        CmbJk.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbJk.setName("CmbJk"); // NOI18N
        CmbJk.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbJkItemStateChanged(evt);
            }
        });
        ...
        jPanel5.add(CmbJk);
        CmbJk.setBounds(130, 89, 160, 26);

        CmbKeluarga.setBorder(null);
        CmbKeluarga.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "DIRI SENDIRI", "ORANG TUA", "ANAK", "SAUDARA" }));
        CmbKeluarga.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbKeluarga.setName("CmbKeluarga"); // NOI18N
        CmbKeluarga.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbKeluargaItemStateChanged(evt);
            }
        });
        ...
        jPanel5.add(CmbKeluarga);
        CmbKeluarga.setBounds(130, 347, 140, 26);

        CmbStts.setBorder(null);
        CmbStts.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "BELUM MENIKAH", "MENIKAH", "JANDA / DUDA" }));
        CmbStts.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        ...
        jPanel5.add(CmbStts);
        CmbStts.setBounds(130, 308, 150, 26);

        CmbKelPJ.setBorder(null);
        CmbKelPJ.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "KELURAHAN / DESA" }));
        CmbKelPJ.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbKelPJ.setName("CmbKelPJ"); // NOI18N
        CmbKelPJ.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbKelPJItemStateChanged(evt);
            }
        });
        CmbKelPJ.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbKelPJKeyPressed(evt);
            }
        });
        jPanel5.add(CmbKelPJ);
        CmbKelPJ.setBounds(370, 449, 200, 26);

        CmbKecPJ.setBorder(null);
        CmbKecPJ.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "KECAMATAN" }));
        CmbKecPJ.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbKecPJ.setName("CmbKecPJ"); // NOI18N
        CmbKecPJ.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbKecPJItemStateChanged(evt);
            }
        });
        CmbKecPJ.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbKecPJKeyPressed(evt);
            }
        });
        jPanel5.add(CmbKecPJ);
        CmbKecPJ.setBounds(130, 449, 200, 26);

        CmbKabPJ.setBorder(null);
        CmbKabPJ.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "KABUPATEN / KOTA" }));
        CmbKabPJ.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbKabPJ.setName("CmbKabPJ"); // NOI18N
        CmbKabPJ.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbKabPJItemStateChanged(evt);
            }
        });
        CmbKabPJ.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbKabPJKeyPressed(evt);
            }
        });
        jPanel5.add(CmbKabPJ);
        CmbKabPJ.setBounds(370, 417, 200, 26);

        CmbProvPJ.setBorder(null);
        CmbProvPJ.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "PROVINSI" }));
        CmbProvPJ.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        CmbProvPJ.setName("CmbProvPJ"); // NOI18N
        CmbProvPJ.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                CmbProvPJItemStateChanged(evt);
            }
        });
        CmbProvPJ.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                CmbProvPJKeyPressed(evt);
            }
        });
        jPanel5.add(CmbProvPJ);
        CmbProvPJ.setBounds(130, 417, 200, 26);

        ChkRM.setSelected(true);
        ChkRM.setBorder(null);
        ChkRM.setName("ChkRM"); // NOI18N
        ChkRM.setOpaque(true);
        jPanel5.add(ChkRM);
        ChkRM.setBounds(550, 10, 20, 20);

        jPanel1.add(jPanel5);
        jPanel5.setBounds(0, 0, 630, 650);

        jScrollPane1.setViewportView(jPanel1);

        jPanel4.add(jScrollPane1, java.awt.BorderLayout.CENTER);

        FormInput.add(jPanel4, java.awt.BorderLayout.WEST);

        jPanel2.setMinimumSize(new java.awt.Dimension(400, 570));
        ...
        FormInput.add(jPanel2, java.awt.BorderLayout.EAST);
        ...
        jPanel3.setMinimumSize(new java.awt.Dimension(811, 44));
        jPanel3.setName("jPanel3"); // NOI18N
        jPanel3.setOpaque(false);
        jPanel3.setPreferredSize(new java.awt.Dimension(44, 45));
        jPanel3.setLayout(new java.awt.BorderLayout(1, 1));

        panelGlass8.setMinimumSize(new java.awt.Dimension(811, 40));
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
    ...
    Propinsi.setText(CmbProv.getSelectedItem().toString());
    Kabupaten.setText(CmbKab.getSelectedItem().toString());
    Kecamatan.setText(CmbKec.getSelectedItem().toString());
    Kelurahan.setText(CmbKel.getSelectedItem().toString());
    
    if(!CmbProvPJ.getSelectedItem().equals(null) || !CmbKabPJ.getSelectedItem().equals(null) || !CmbKecPJ.getSelectedItem().equals(null) || !CmbKelPJ.getSelectedItem().equals(null)){
        PropinsiPj.setText(CmbProv.getSelectedItem().toString());
        KabupatenPj.setText(CmbKab.getSelectedItem().toString());
        KecamatanPj.setText(CmbKec.getSelectedItem().toString());
        KelurahanPj.setText(CmbKel.getSelectedItem().toString());
    }else{
        PropinsiPj.setText("");
        KabupatenPj.setText("");
        KecamatanPj.setText("");
    ...
    if (TKtp.getText().trim().equals("")) {
        ...
        Valid.textKosong(TTmp, "Templat Lahir");
    } else if (Alamat.getText().trim().equals("")) {
        Valid.textKosong(Alamat, "Alamat Pasien");
    } else if (TTlp.getText().trim().equals("")) {
        Valid.textKosong(TTlp, "No Telepon");
    } else if (Saudara.getText().trim().equals("")) {
        if(!CmbKeluarga.getSelectedItem().toString().equals("DIRI SENDIRI")){
            Valid.textKosong(Saudara, "Nama Penanggung Jawab");
        }
//    }
...
//            Valid.textKosong(nmjabatanpolri,"Jabatan POLRI");
        ...
        if (Sequel.menyimpantf2("pasien", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rekam Medis Pasien", 36, new String[]{
            TNo.getText(), TNm.getText()+" ."+CmbSebutan.getSelectedItem().toString(), TKtp.getText(), CmbJk.getSelectedItem().toString().substring(0, 1), TTmp.getText(),
...
//            System.out.println("JK "+cekViaBPJS.sex);
//            TNm.setText(cekViaBPJS.nama);

            if (cekViaBPJS.sex.toLowerCase().contains("l")) {
...
//            }
//        }
//        if (CmbJk.getSelectedItem().toString().toLowerCase().contains("perempuan")) {
//            if (Integer.valueOf(TUmurTh.getText()) < 18) {
////                    TNm.setText(cekViaBPJS.nama+ " .AN");
//                CmbSebutan.setSelectedItem("AN");
//            } else if (Integer.valueOf(TUmurTh.getText()) >= 18 && Integer.valueOf(TUmurTh.getText()) <= 23) {
...
//        }
    ...
    private void CmbKabKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbKabKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbKabKeyPressed

    private void CmbCacatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbCacatKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbCacatKeyPressed

    private void CmbProvKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbProvKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbProvKeyPressed

    private void CmbKelKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbKelKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbKelKeyPressed

    private void CmbKecKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbKecKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbKecKeyPressed

    private void CmbSebutanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbSebutanKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbSebutanKeyPressed
    ...
    private void CmbKelPJKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbKelPJKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbKelPJKeyPressed

    private void CmbKecPJKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbKecPJKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbKecPJKeyPressed

    private void CmbKabPJKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbKabPJKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbKabPJKeyPressed

    private void CmbProvPJKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CmbProvPJKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_CmbProvPJKeyPressed
    ...
    private void nmcacatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nmcacatKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_nmcacatKeyPressed

    private void CmbSebutanItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbSebutanItemStateChanged
        // TODO add your handling code here:
        if (CmbSebutan.getSelectedItem().toString().toLowerCase().contains("tn")) {
            CmbJk.setSelectedItem("LAKI-LAKI");
            CmbStts.setSelectedItem("MENIKAH");
        } else if (CmbSebutan.getSelectedItem().toString().toLowerCase().contains("sdr")) {
            CmbJk.setSelectedItem("LAKI-LAKI");
            CmbStts.setSelectedItem("BELUM MENIKAH");
        } else if (CmbSebutan.getSelectedItem().toString().toLowerCase().contains("ny")) {
            CmbJk.setSelectedItem("PEREMPUAN");
            CmbStts.setSelectedItem("MENIKAH");
        } else if (CmbSebutan.getSelectedItem().toString().toLowerCase().contains("nn")) {
            CmbJk.setSelectedItem("PEREMPUAN");
            CmbStts.setSelectedItem("BELUM MENIKAH");
        } else if (CmbSebutan.getSelectedItem().toString().toLowerCase().contains("an")) {
            CmbStts.setSelectedItem("BELUM MENIKAH");
...
//        CmbJk.requestFocus();
    ...
    private void CmbKeluargaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbKeluargaItemStateChanged
        // TODO add your handling code here:
        if (CmbKeluarga.getSelectedItem().toString().toLowerCase().contains("diri sendiri")) {
            lblNamaPJ.setVisible(false);
            lblAlamatPJ.setVisible(false);
            Saudara.setVisible(false);
            ChkAlamatPJ.setSelected(true);
            ChkAlamatPJ.setVisible(false);
            AlamatPj.setVisible(false);
            CmbKelPJ.setVisible(false);
            CmbKecPJ.setVisible(false);
            CmbKabPJ.setVisible(false);
            CmbProvPJ.setVisible(false);
        } else {
            lblNamaPJ.setVisible(true);
            lblAlamatPJ.setVisible(true);
            Saudara.setVisible(true);
            ChkAlamatPJ.setVisible(true);
            ChkAlamatPJ.setSelected(true);
            AlamatPj.setVisible(true);
            CmbKelPJ.setVisible(true);
            CmbKecPJ.setVisible(true);
            CmbKabPJ.setVisible(true);
            CmbProvPJ.setVisible(true);
        }
    }//GEN-LAST:event_CmbKeluargaItemStateChanged
    ...
    private void CmbKelItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbKelItemStateChanged
        // TODO add your handling code here:
        if (ChkAlamatPJ.isSelected()) {
            CmbKelPJ.setSelectedItem(CmbKel.getSelectedItem());
        }
//        Kelurahan.setText(CmbKel.getSelectedItem().toString());
    }//GEN-LAST:event_CmbKelItemStateChanged

    private void CmbKabItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbKabItemStateChanged
        // TODO add your handling code here:
        CmbKec.removeAllItems();
        try {
            pskec = koneksi.prepareStatement(
                    "select * from districts inner join regencies on regencies.id=districts.regency_id where regencies.name like ? order by districts.name");
            pskec.setString(1, CmbKab.getSelectedItem().toString());
            rs4 = pskec.executeQuery();
            while (rs4.next()) {
                CmbKec.addItem(rs4.getString("name"));
                CmbKecPJ.addItem(rs4.getString("name"));
            }
        } catch (Exception e) {
        }
        if (ChkAlamatPJ.isSelected()) {
            CmbKabPJ.setSelectedItem(CmbKab.getSelectedItem());
        }
    }//GEN-LAST:event_CmbKabItemStateChanged

    private void CmbKecItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbKecItemStateChanged
        // TODO add your handling code here:
        CmbKel.removeAllItems();
        try {
            pskel = koneksi.prepareStatement(
                    "select * from villages inner join districts on districts.id=villages.district_id where districts.name like ? order by villages.name");
            pskel.setString(1, CmbKec.getSelectedItem().toString());
            rs5 = pskel.executeQuery();
            while (rs5.next()) {
                CmbKel.addItem(rs5.getString("name"));
                CmbKelPJ.addItem(rs5.getString("name"));
            }
        } catch (Exception e) {
        }
        if (ChkAlamatPJ.isSelected()) {
            CmbKecPJ.setSelectedItem(CmbKec.getSelectedItem());
        }
//        Kecamatan.setText(CmbKec.getSelectedItem().toString());
    }//GEN-LAST:event_CmbKecItemStateChanged
    ...
    private void CmbProvItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbProvItemStateChanged
        ...
        try {
            pskab = koneksi.prepareStatement(
                    "select * from regencies inner join provinces on provinces.id=regencies.province_id where provinces.name like ?");
            pskab.setString(1, CmbProv.getSelectedItem().toString());
            rs3 = pskab.executeQuery();
            while (rs3.next()) {
                CmbKab.addItem(rs3.getString("name"));
                CmbKabPJ.addItem(rs3.getString("name"));
            }
            CmbKab.setSelectedItem("KABUPATEN KUNINGAN");
            CmbKabPJ.setSelectedItem("KABUPATEN KUNINGAN");
        } catch (Exception e) {
        }
        if (ChkAlamatPJ.isSelected()) {
            CmbProvPJ.setSelectedItem(CmbProv.getSelectedItem());
        }
//        Propinsi.setText(CmbProv.getSelectedItem().toString());
    ...
    private void CmbJkItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbJkItemStateChanged
        // TODO add your handling code here:
//        if (CmbJk.getSelectedItem().toString().toLowerCase().contains("laki-laki")) {
//            if (Integer.valueOf(TUmurTh.getText()) < 18) {
////                    TNm.setText(cekViaBPJS.nama+ " .AN");
...
//            }
//        }
    }//GEN-LAST:event_CmbJkItemStateChanged
...
////                    TNm.setText(cekViaBPJS.nama+ " .AN");
//                CmbSebutan.setSelectedItem("AN");
//            } else if (Integer.valueOf(TUmurTh.getText()) >= 18 ) {
////                    TNm.setText(cekViaBPJS.nama+ " .SDR");
//                CmbSebutan.setSelectedItem("SDR");
//            } else {
////                    TNm.setText(cekViaBPJS.nama+ " .TN");
...
//        }
    ...
    private void CmbProvPJItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbProvPJItemStateChanged
        // TODO add your handling code here:
//        if(!CmbProvPJ.getSelectedItem().equals(null)){
//            PropinsiPj.setText(CmbProvPJ.getSelectedItem().toString());
//        }
        
    }//GEN-LAST:event_CmbProvPJItemStateChanged

    private void CmbKabPJItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbKabPJItemStateChanged
        // TODO add your handling code here:
//        if(!CmbKabPJ.getSelectedItem().equals(null)){
//            KabupatenPj.setText(CmbKabPJ.getSelectedItem().toString());
//        }
        
    }//GEN-LAST:event_CmbKabPJItemStateChanged

    private void CmbKecPJItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbKecPJItemStateChanged
        // TODO add your handling code here:
//        if(!CmbKecPJ.getSelectedItem().equals(null)){
//            KecamatanPj.setText(CmbKecPJ.getSelectedItem().toString());
//        }
        
    }//GEN-LAST:event_CmbKecPJItemStateChanged

    private void CmbKelPJItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CmbKelPJItemStateChanged
        // TODO add your handling code here:
//        if(!CmbKelPJ.getSelectedItem().equals(null)){
//            KelurahanPj.setText(CmbKelPJ.getSelectedItem().toString());
//        }
        
    }//GEN-LAST:event_CmbKelPJItemStateChanged
    ...
    private javax.swing.JTextField AlamatPj;
    ...
    private javax.swing.JCheckBox ChkAlamatPJ;
    ...
    private widget.ComboBox CmbKab;
    private widget.ComboBox CmbKabPJ;
    private widget.ComboBox CmbKec;
    private widget.ComboBox CmbKecPJ;
    private widget.ComboBox CmbKel;
    private widget.ComboBox CmbKelPJ;
    private widget.ComboBox CmbKeluarga;
    private widget.ComboBox CmbProv;
    private widget.ComboBox CmbProvPJ;
    private widget.ComboBox CmbSebutan;
    ...
    private javax.swing.JTextField Saudara;
    ...
    private javax.swing.JTextField TNoPeserta;
    private javax.swing.JTextField TTlp;
    private javax.swing.JTextField TTmp;
    private javax.swing.JTextField TUmurBl;
    private javax.swing.JTextField TUmurHr;
    private javax.swing.JTextField TUmurTh;
    ...
    private javax.swing.JLabel lblAlamatPJ;
    private javax.swing.JLabel lblNamaPJ;
    ...
    private widget.TextBox nmperusahaan, nmbahasa, nmsukubangsa, NmIbu, Pekerjaan, PekerjaanPj,
            EMail, NIP;
    private widget.ComboBox cmbAgama, CMbPnd;
    ...
    private void tampil() {
        ...
        try {
            ...
            try {
                ...
                psprov = koneksi.prepareStatement(
                        "select * from provinces");
                rs2 = psprov.executeQuery();
                while (rs2.next()) {
                    CmbProv.addItem(rs2.getString("name"));
                    CmbProvPJ.addItem(rs2.getString("name"));
                }
                CmbProv.setSelectedItem("JAWA BARAT");
                CmbProvPJ.setSelectedItem("JAWA BARAT");
    ...
    public void emptTeks() {
        ...
        TTmp.setText("KUNINGAN");
        cmbAgama.setSelectedIndex(0);
        CmbStts.setSelectedIndex(0);
        Alamat.setText("DUSUN RT RW");
        AlamatPj.setText("DUSUN RT RW");
        TKtp.setText("");
        TNoPeserta.setText("");
        Pekerjaan.setText("-");
        PekerjaanPj.setText("-");
        ...
        Kelurahan.setText("KELURAHAN");
        Kecamatan.setText("KECAMATAN");
        Kabupaten.setText("KUNINGAN");
        Propinsi.setText("JAWA BARAT");
        KelurahanPj.setText("KELURAHAN");
        KecamatanPj.setText("KECAMATAN");
        KabupatenPj.setText("KUNINGAN");
        PropinsiPj.setText("JAWA BARAT");
        kdcacat.setText("17");
...
//                nmPasien = tbPasien.getValueAt(tbPasien.getSelectedRow(), 2).toString().split(".");
                TNm.setText(tbPasien.getValueAt(tbPasien.getSelectedRow(), 2).toString());
//                CmbSebutan.setSelectedItem(nmPasien[1]);
